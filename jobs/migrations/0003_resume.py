# Generated by Django 4.1 on 2023-08-07 07:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('jobs', '0002_alter_job_created_date_alter_job_job_name_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candicate_introduction', models.TextField(blank=True, max_length=1024, verbose_name='自我介绍')),
                ...
                ('applicant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='候选人')),
            ],
            options={
                'verbose_name': '简历',
                'verbose_name_plural': '所有简历',
            },
        ),
    ]
