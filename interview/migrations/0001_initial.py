    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=135, verbose_name='手机号码')),
                ...
                ('degree', models.CharField(blank=True, choices=[('本科', '本科'), ('硕士', '硕士'), ('博士', '博士')], max_length=135, verbose_name='学位')),
                ('test_score_of_general_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='综合能力测试成绩')),
                ...
                ('first_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('待定', '待定')], max_length=256, verbose_name='初试结果')),
                ('first_remark', models.CharField(blank=True, max_length=135, verbose_name='初试备注')),
                ('second_score', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='专业复试分')),
                ...
                ('second_pursue_of_excellence', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='追求卓越分')),
                ('second_communication_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='沟通能力分')),
                ('second_pressure_score', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='抗压能力分')),
                ...
                ('second_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('待定', '待定')], max_length=256, verbose_name='专业复试结果')),
                ...
                ('hr_level', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR复试综合等级')),
                ('hr_responsibility', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR责任心')),
                ('hr_communication_ability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR坦诚沟通分')),
                ...
                ('hr_result', models.CharField(blank=True, choices=[('建议录取', '建议录取'), ('待定', '待定'), ('放弃', '放弃')], max_length=256, verbose_name='HR复试结果')),
                ('hr_interviewer', models.CharField(blank=True, max_length=135, verbose_name='HR面试官')),
                ('hr_remark', models.CharField(blank=True, max_length=256, verbose_name='复试备注')),
                ('creator', models.CharField(blank=True, max_length=135, verbose_name='候选人数据的创建人')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('modified_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='更新时间')),
                ('last_editor', models.CharField(blank=True, max_length=256, verbose_name='最后编辑这')),
            ],
            options={
                'verbose_name': '应聘者',
